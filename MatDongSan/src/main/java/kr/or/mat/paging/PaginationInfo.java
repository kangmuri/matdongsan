...
public class PaginationInfo {
	...
	@Setter
	private Map<String, Object> detailConditions = new LinkedHashMap<>();
	
	public void addDetailCondition(String conditionType, Object conditionValue) {
		detailConditions.put(conditionType, conditionValue);
	}

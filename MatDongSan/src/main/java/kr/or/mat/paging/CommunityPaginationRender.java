...
public class CommunityPaginationRender implements PaginationRenderer {

    @Override
    public String renderPagination(PaginationInfo pagingVO, String funcName) {
        // 모든 a 태그에 data-page 속성이 있음에 주의할 것.
        String firstPtrn = "<a data-v-7136ea58='' class='btn init' href='javascript:;' %2$s data-page='1' onclick='return false;'></a>";
        String lastPtrn = "<a data-v-7136ea58='' class='btn end' href='javascript:;' %2$s data-page='%3$d' onclick='return false;'></a>";
        String previousPtrn = "<a data-v-7136ea58='' class='btn prev' href='javascript:;' %2$s data-page='%3$d' onclick='return false;'></a>";
        String nextPtrn = "<a data-v-7136ea58='' class='btn next' href='javascript:;' %2$s data-page='%3$d' onclick='return false'></a>";
        String pagePtrn = "<a data-v-7136ea58='' class='num' href='javascript:;' data-page='%1$d' onclick='return false;'>%1$d</a>";
        String currentPtrn = "<a data-v-7136ea58='' class='num active' href='javascript:;'>%d</a>";
        ...
        html.append("<div data-v-7136ea58='' class='paging-wrap mt35'>");

                    ...
                    <div class="nav-inner">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="${pageContext.request.contextPath}/">
                                <img src="${pageContext.request.contextPath}/resources/classigrids-full/Template Main/assets/images/logo/mdslogo.png" alt="Logo" style="margin: 0px;">
                            </a>
...
<!--                                             aria-controls="navbarSupportedContent" aria-expanded="false" -->
	                            ...
	                            <security:authorize url="/logout">
		                            <div class="login-button" style="margin-left: 84px;">
		                                <ul>
		                                    <li>
				                        	...
				                        	<li style="position: absolute;top: 46px;">										
					                        	<!-- 드롭다운 메뉴바 -->

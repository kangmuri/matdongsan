...
<%--     <h1>${list }</h1> --%>
<%--     <c:forEach items="${list }" val="calList"> --%>
<!--     <form name="calForm"> -->
<%--     	<input type="hidden" value="${calList.schdulSj }" name="schdulSj"> --%>
<%--     	<input type="hidden" value="${calList.schdulBgnde }" name="schdulBgnde"> --%>
<%--     	<input type="hidden" value="${calList.schdulEndde }" name="schdulEndde"> --%>
<!--     </form> -->
<%--     </c:forEach> --%>
    <!-- 실제 화면을 담을 영역 -->
    <div id="Wrapper">
